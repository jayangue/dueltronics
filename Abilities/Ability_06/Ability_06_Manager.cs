...
public class Ability_06_Manager : MonoBehaviour
{
    ...
    public void Setup(GameObject caster)
    {
       ...
       //Set prefab data
       created_prefab.GetComponent<Ability_06_Prefab_Script>().Setup(duration,master_manager,caster,owner,multiplier);
