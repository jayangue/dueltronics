...
public class Ability_01_Projectile_Script : MonoBehaviour
{
    ...
    public void Setup(int damage,float move_angle, float move_speed, float move_rotation, GameObject master_manager, Transform on_hit_sfx)
    {
